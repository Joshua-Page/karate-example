    ...
    return (
        <div className="classes-section" id="classes">
            ...
            <div className="calendar">
                <CalendarSmall />
                <div className="map">
                    <iframe width="100%" height="600" title="map" frameBorder="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=london+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
            </div>
